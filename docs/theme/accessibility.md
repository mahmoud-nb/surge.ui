...
| Niveau | Ratio | Contexte | Notre garantie |
|--------|-------|----------|----------------|
| **AA** | 4.5:1 | Texte normal | ✅ Minimum respecté |
| **AA Large** | 3:1 | Texte large (18px+) | ✅ Dépassé |
| **AAA** | 7:1 | Texte normal | ✅ Recommandé par défaut |
| **AAA Large** | 4.5:1 | Texte large | ✅ Dépassé |
...
- [Stark](https://www.getstark.co/) - Vérification en temps réel
- [axe DevTools](https://www.deque.com/axe/devtools/) - Audit complet
